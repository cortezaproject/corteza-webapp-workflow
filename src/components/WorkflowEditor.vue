<template>
  ...
  >
    ...
    >
      <b-card-header
        class="d-flex flex-column justify-content-between align-items-center sticky-top h5 px-2 pb-4"
  ...
  methods: {
    ...
    keys() {
      ...
      this.keyHandler.controlKeys[32] = () => {
        this.graph.zoomTo(1)
        this.graph.view.setTranslate(-1041, -1041)
      }
    },
    ...
    render (workflow) {
      ...
      const { x, y } = this.graph.view.translate
